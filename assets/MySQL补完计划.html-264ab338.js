import{_ as s,r as a,o as l,c as r,a as e,b as i,e as t,d as n}from"./app-b0d8ba6a.js";const v={},c=n(`<h1 id="mysql补完计划" tabindex="-1"><a class="header-anchor" href="#mysql补完计划" aria-hidden="true">#</a> MySQL补完计划</h1><h2 id="_1-date数据类型的加减" tabindex="-1"><a class="header-anchor" href="#_1-date数据类型的加减" aria-hidden="true">#</a> 1 Date数据类型的加减</h2><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>Create table If Not Exists Activity (player_id int, device_id int, event_date date, games_played int)
