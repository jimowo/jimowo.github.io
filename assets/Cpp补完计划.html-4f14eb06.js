import{_ as e,o as n,c as i,d as l}from"./app-b0d8ba6a.js";const t={},s=l(`<h1 id="cpp补完计划" tabindex="-1"><a class="header-anchor" href="#cpp补完计划" aria-hidden="true">#</a> Cpp补完计划</h1><h2 id="_1-智能指针" tabindex="-1"><a class="header-anchor" href="#_1-智能指针" aria-hidden="true">#</a> 1 智能指针</h2><p>C++11 提供3种智能指针 unique_ptr, shared_ptr, weak_ptr</p><h3 id="_1-1-几个简单例子" tabindex="-1"><a class="header-anchor" href="#_1-1-几个简单例子" aria-hidden="true">#</a> 1.1 几个简单例子</h3><div class="language-c++ line-numbers-mode" data-ext="c++"><pre class="language-c++"><code>#include &lt;memory&gt;
#include &lt;iostream&gt;
using namespace std;
int main() {
